...
import HealthInsuranceQuestion from '../../components/health-insurance-question';
import HealthInsuranceAnswer from '../../components/health-insurance-answer';
import CovidPandemicQuestion from '../../components/covid-pandemic-question';
import CovidPandemicAnswer from '../../components/covid-pandemic-answer';
import DrugImportQuestion from '../../components/drug-import-question';
import DrugImportAnswer from '../../components/drug-import-answer';
...
export default ({ data }) => {
  ...
  return (
    ...
    {intro.edges.map(({ node }, index) => (
     ...
     <CovidPandemicQuestion/>
     <CovidPandemicAnswer/>
      <HealthInsuranceQuestion/>
      <HealthInsuranceAnswer/>
      <DrugImportQuestion/>
      <DrugImportAnswer/>
      </div>   
      </div></div></div>
      ...
      {
        allGoogleSpreadsheetCategories(filter: {categorySlug: {eq: "health-care"}}) {
          edges {
            node {
              categoryName
              categorySlug
