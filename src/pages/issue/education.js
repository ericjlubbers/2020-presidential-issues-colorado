...
import TeacherPayQuestion from '../../components/teacher-pay-question';
import TeacherPayAnswer from '../../components/teacher-pay-answer';
...
<TeacherPayAnswer/>
      ...
      {
        allGoogleSpreadsheetCategories(filter: {categorySlug: {eq: "education"}}) {
          edges {
            node {
              categoryName
              categorySlug
