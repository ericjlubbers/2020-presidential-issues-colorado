...
import BlmRelocationQuestion from '../../components/blm-relocation-question';
import BlmRelocationAnswer from '../../components/blm-relocation-answer';
import CoreActQuestion from '../../components/core-act-question';
import CoreActAnswer from '../../components/core-act-answer';
import OilPublicLandsQuestion from '../../components/oil-public-lands-question';
import OilPublicLandsAnswer from '../../components/oil-public-lands-answer';
...
<BlmRelocationQuestion/>
<BlmRelocationAnswer/>
<CoreActQuestion/>
<CoreActAnswer/>
<OilPublicLandsQuestion/>
<OilPublicLandsAnswer/>
      </div>   
      </div></div></div>
      ...
      {
        allGoogleSpreadsheetCategories(filter: {categorySlug: {eq: "public-lands"}}) {
          edges {
            node {
              categoryName
              categorySlug
