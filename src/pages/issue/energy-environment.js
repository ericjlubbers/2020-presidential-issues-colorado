...
import ClimateChangeQuestion from '../../components/climate-change-question';
import ClimateChangeAnswer from '../../components/climate-change-answer';
import ColoradoRiverQuestion from '../../components/colorado-river-question';
import ColoradoRiverAnswer from '../../components/colorado-river-answer';
...
export default ({ data }) => {
  ...
  return (
    ...
    {intro.edges.map(({ node }, index) => (
      ...
      <FrackingQuestion/>
      <FrackingAnswer/>
      <ClimateChangeQuestion/>
      <ClimateChangeAnswer/>
      <ColoradoRiverQuestion/>
      <ColoradoRiverAnswer/>
      <WildfiresQuestion/>
      <WildfiresAnswer/>
