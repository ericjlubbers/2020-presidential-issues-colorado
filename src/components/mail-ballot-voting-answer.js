        ...
        export default () => (
          ...
          query={graphql`
          {
            allGoogleSpreadsheetAnswers(filter: {questionSlug: {regex: "/mail-ballot-voting/"}}, sort: {fields: candidateId, order: ASC}) {
              edges {
                node {
                  background
                  candidateName
        ...
        <div>
            ...
            <div class="column is-3 is-3-tablet is-3-desktop is-3-fullhd">
